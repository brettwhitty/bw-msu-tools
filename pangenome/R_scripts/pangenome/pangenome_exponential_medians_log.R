...
postscript(file="###output_path###pangenome_exponential_medians_log.ps", width=11, height=8.5, paper='special')
layout(matrix(c(1,2),byrow=TRUE), heights=c(7.5,1))

# Draw the axis
plot(V1,V2, ylim=c(min(V2),(nlmodel_exp$m$getPars()[1]*1.1)), xlab="number of genomes", ylab="number of genes", main="###TITLE### pan-genome exponential log axis", cex=0.5, log="xy")
