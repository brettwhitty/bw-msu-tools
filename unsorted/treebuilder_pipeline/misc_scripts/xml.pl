...
#        print OUT "/share/data2/whitty/potato/phylo/bin/create_newick_file.pl  -i $path_to_outfile  -o $path_to_outtree  \n";
#    }
    ...
    print OUT "/share/data2/whitty/potato/phylo/bin/decode_sequence_ids.pl  -i $phyloxml_output_file  -d $path_to_decoder_file\n"; 
    print OUT "/share/data2/whitty/potato/phylo/bin/convert_and_decode_phyi_file.pl  -i $phylip_interleave_output_file  -o $msa_output_file  -d $path_to_decoder_file\n"; 
    print OUT "cd $cwd\n";
...
print "qsub -V  -t 1-$num_jobs -v \"INFILE=$command_line_file\" $shell_out\n";
system("qsub -V  -t 1-$num_jobs -v \"INFILE=$command_line_file\" $shell_out");
